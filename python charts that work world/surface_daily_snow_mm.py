...
features = [
    ...
    # (other optional features remain commented out per playbook)
]
...
def process_frame(args):
    ...
    with Dataset(ncfile_path) as ncfile, Dataset(prev_ncfile_path) as prev_ncfile:
        ...
        cbar.set_label("Daily Total Snow Precipitation (mm)", fontsize=14)
        ...
        plt.title(
            ...
            "Daily Total Snow Precipitation (mm)\n"
        ...
        # -------------------------------------------------------------------------
        # Save PNG with timestamp from latest_datetime for GIF sorting
        # -------------------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 3:
        print(
            ...
            "For example: SFC_DailySnow_mm_multicore_v3.py "
