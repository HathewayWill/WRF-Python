...
Plot WRF cloud-top temperature (°C) on a Cartopy map.
...
def process_frame(args):
    ...
    with Dataset(ncfile_path) as ncfile:
        ...
        # -------------------------------------------------------------------------
        # Cloud-top temperature (°C, as in original script)
        ...
        # -------------------------------------------------------------------------
        # Cloud-top temperature filled contours
        # -------------------------------------------------------------------------
        ...
        file_out = f"wrf_{domain}_Cloud_Temp_{fname_time}.png"
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 3:
        print(
            ...
            "For example:\n"
            "    Cloud_Top_Temp.py /home/WRF/test/em_real d01\n"
        )
        sys.exit(1)
    ...
    # -------------------------------------------------------------------------
    path_figures = "wrf_Cloud_Top_Temp"
    ...
    gif_file_out = f"wrf_{domain}_Cloud_Top_Temp.gif"
