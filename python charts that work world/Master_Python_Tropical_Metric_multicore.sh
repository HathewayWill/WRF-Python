...
#    for multiple domains and multiple point locations in Saudi Arabia.
###############################################################################
...
run_vertical_wind() {
  ...
  for location in "${!locations[@]}"; do
    ...
    # Convention: <wrf_run_dir> <domain> <lat> <lon>
...
echo "Running point-based charts for domain d02 (Saudi Arabia)."
...
###############################################################################
# Scripts to run in parallel for domain d02 (metric)
###############################################################################
d02_scripts=(
